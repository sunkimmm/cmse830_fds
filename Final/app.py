...
with tab4:
    ...
    with subtab1:
        ...
        with col1:
            ...
            st.markdown(
                f"<div style='background-color:#e8f4e8; padding:15px; border-radius:10px; max-height:500px; overflow-y:auto; font-size:12px;'>{appraisal_text}</div>",
        ...
        with col2:
            ...
            st.markdown(
                f"<div style='background-color:#e8f0f4; padding:15px; border-radius:10px; max-height:500px; overflow-y:auto; font-size:12px;'>{completion_text}</div>",
                unsafe_allow_html=True
            )
